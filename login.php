...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Login in for Attendance</p>
      ...
      <form method="POST">
        ...
        <div align="right">
          <button type="submit" class="btn btn-primary btn-flat" name="logout"><i class="fas fa-sign-in-alt"></i> Log In</button>
        </div>
