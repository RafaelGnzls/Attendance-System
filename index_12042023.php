...
if(isset($_POST['attendance']))
{
  ...
  if($code == "morn-in")
  {
    ...
    if(!$row = $result->fetch_assoc()) {
      ...
      $filename =  date("Y m d_H i s").'.jpg';
      $filepath = 'cam/'; 
      $sql2 = "UPDATE emp_attendance SET mor_in = '$in', attendance_hour = '$int', morin_cam = '$filename' WHERE employee_id = '$id' AND attendance_date = '$date'";
      $result2 = mysqli_query($db, $sql2);
      echo $filepath.$filename;
      $_SESSION['mess'] = "<div id='time' class='alert alert-success' role='alert'>
                            <i class='fas fa-check'></i>  15 MINS LANG BREAK HA!!!!!
                           </div>";
      header("Location: index.php");
     }
...
<div class="login-box">
  <div class="login-logo">
    ...
    <p id="current_time" class="bold"><?php echo $current_time; ?></p>
  </div>
  <!-- /.login-logo -->
      ...
      <form method="POST">
        ...
        <div class="input-group mb-3">
          <select name="operation" class="form-control">
            ...
            <option value="morn-in">Morning Coffee Break In</option>
            <option value="morn-out">Morning Coffee Break Out</option>
            <option value="lunch-in">Lunch Break In</option>
            <option value="lunch-out">Lunch Break Out</option>
            <option value="aft-in">Afternoon Coffee Break In</option>
            <option value="aft-out">Afternoon Coffee Break Out</option>
          </select>
        </div>
