            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered dataTable no-footer" role="grid" aria-describedby="example1_info">
                ...
                <tr>
                  ...
                  <th>Lunch In</th>
                  <th>Lunch Out</th>
                  <th>Coffee Break In</th>
                  <th>Coffee Break Out</th>
                  <th>Time Out</th>
                  <th>Action</th>
                </tr>
                </thead>
...
and emp_attendance.attendance_date  between '{$date}' and '{$date2}' and ref_campaign.campaign_id = '{$campaign_id}' order by emp_attendance.attendance_date,emp_attendance.employee_name";
                ...
                ?>
                  <tr style="text-align: center;">
                    ...
                    <td> <?php echo date('h:i:s a', strtotime( $row['attendance_timein']));?><span class="float-right badge bg-success">On Time</span></td>
                    <td> <?php echo date('h:i:s a', strtotime( $row['mor_in']));?></td>
                    <td> <?php echo date('h:i:s a', strtotime( $row['mor_out']));?></td>
                    <td> <?php echo date('h:i:s a', strtotime( $row['lunch_in']));?></td>
                    <td> <?php echo date('h:i:s a', strtotime( $row['lunch_out']));?></td>
                    <td> <?php echo date('h:i:s a', strtotime( $row['coff_in']));?></td>
                    <td> <?php echo date('h:i:s a', strtotime( $row['coff_out']));?></td>
                    <td> <?php echo date('h:i:s a', strtotime( $row['attendance_timeout']));?></td>
                ...
                <tr style="text-align: center;">
                  ...
                  <td><?php 
                  $time_in = $row['attendance_timeout']?>
                  <?php  if (!is_numeric($time_in)) {
                        $time_in = strtotime($time_in);
