...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: #222d32;">
    ...
    <a href="employee_attendance_BMI.php" class="brand-link">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-flat nav-legacy nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="employee_attendance_BMI.php" class="nav-link active">
...
and emp_attendance.attendance_date  between '{$date}' and '{$date2}' and ref_campaign.campaign_id = '3' order by emp_attendance.attendance_date,emp_attendance.employee_name";
